...
const getItemMetadata = (itemType: ItemType, props: Props<any>, index: number, instanceProps: InstanceProps): ItemMetadata => {
  ...
  if (itemType === 'column') {
    ...
    itemSize = ((props.rowHeight as any) as itemSizeGetter);
...
const getOffsetForIndexAndAlignment = (itemType: ItemType, props: Props<any>, index: number, align: ScrollToAlign, scrollOffset: number, instanceProps: InstanceProps, scrollbarSize: number): number => {
...
const VariableSizeGrid = createGridComponent({
  ...
  getOffsetForColumnAndAlignment: (props: Props<any>, index: number, align: ScrollToAlign, scrollOffset: number, instanceProps: InstanceProps, scrollbarSize: number): number => getOffsetForIndexAndAlignment('column', props, index, align, scrollOffset, instanceProps, scrollbarSize),

  getOffsetForRowAndAlignment: (props: Props<any>, index: number, align: ScrollToAlign, scrollOffset: number, instanceProps: InstanceProps, scrollbarSize: number): number => getOffsetForIndexAndAlignment('row', props, index, align, scrollOffset, instanceProps, scrollbarSize),
  ...
  initInstanceProps(props: Props<any>, instance: any): InstanceProps {
    const {
      estimatedColumnWidth,
      estimatedRowHeight
    } = ((props as any) as VariableSizeProps);
